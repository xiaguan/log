...
int main(){
    ...
    std::cout << "-----------Test with " <<N<<" push and pop repeat 100 times"<<std::endl;
    ...
    std::cout << std::endl;
    std::cout << "-----------Test with 100 push and pop repeat "<<N<<" times"<<std::endl;
    std::cout <<" The result of mine : ";
    timer.start();
    for(int j = 0;j<N;j++){
        su::stack<int> nums;
    ...
    std::cout << "-----------Test with 300 push and pop repeat "<<N<<" times"<<std::endl;
    std::cout <<" The result of mine : ";
    timer.start();
    for(int j = 0;j<N;j++){
        su::stack<int> nums;
